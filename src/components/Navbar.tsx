      ...
      <header className="fixed top-0 left-0 right-0 z-50 pointer-events-none flex justify-center select-none">
        ...
        <div className="flex sm:hidden w-full px-2 justify-center">
          <motion.div
            ...
            className="pointer-events-auto relative w-full max-w-[480px] bg-white/70 backdrop-blur-xl shadow-[0_10px_40px_rgba(15,45,129,0.12)] border border-navy/10 border-t-0 rounded-b-[1.25rem] px-3 py-2 overflow-hidden flex flex-row items-center justify-between"
          >
            {/* Uniform Noise Scrim */}
            <div
            ...
            <div className="relative z-10 flex flex-row items-center gap-2 min-[380px]:gap-3 shrink-0">
              ...
              <motion.button
                ...
                className="bg-yellow text-navy text-[9px] min-[380px]:text-[10px] font-black tracking-widest uppercase px-3 py-2 min-[380px]:px-4 min-[380px]:py-2.5 rounded-lg shadow-sm transition-colors duration-200 antialiased whitespace-nowrap text-center"
              >
                Book Now
              </motion.button>
            </div>
        ...
        <div className="hidden sm:flex w-full max-w-7xl mx-auto px-6 md:px-8 items-stretch justify-between">
          ...
          <motion.div
            ...
            className="pointer-events-auto relative bg-white/70 backdrop-blur-xl shadow-[0_10px_40px_rgba(15,45,129,0.12)] border border-navy/10 border-t-0 rounded-b-[2rem] px-6 py-4 overflow-hidden flex items-center justify-center"
          >
            <div
              style={{ backgroundImage: noiseTexture }}
              className="absolute inset-0 opacity-[0.04] mix-blend-multiply pointer-events-none"
          ...
          >
            ...
            <div className="relative z-10 flex flex-row items-center gap-5">
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                onClick={() => setIsModalOpen(true)}
                className="bg-yellow text-navy text-base font-black tracking-widest uppercase px-10 py-4 rounded-xl shadow-sm transition-colors duration-200 antialiased whitespace-nowrap"
              >
                Book Now
              </motion.button>
            </div>
